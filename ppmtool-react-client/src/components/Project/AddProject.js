...
//Proptypes
//connect 
//import the action create project
//checkout classnames from bootstrap
...
class AddProject extends Component {
    ...
    //pass the new project inside and the history
    onSubmit(e) {
        e.preventDefault();
        const newProject = { 
            ...
            <div>
                {
                    ...
                    //bind on contructor
                    //chech the state change in the react extension
                    //check the names so that they match the names of the vars in the server
